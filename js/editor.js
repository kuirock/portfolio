...
function resizeContainer() {
    const margin = 40; // 20px padding around container
    const scaleX = (window.innerWidth - margin) / 1280;
    const scaleY = (window.innerHeight - margin) / 720;
    currentScale = Math.min(scaleX, scaleY, 1); // Don't scale above 1x to avoid pixelation
...
${cssContent}
  ...
  body { cursor: none; }
  .slide-container { border: none; box-shadow: none; }
